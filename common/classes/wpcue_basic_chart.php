...
{
    class WpCueBasicChart extends WpCueQuiz_Base
    {
	...
	public function chart_shortcode($atts){
		...
		wp_register_script( 'flot-excanvas', WPCUES_BASICQUIZ_URL.'/common/js/flot/excanvas.min.js', array('jquery'), '3.6.3');
		wp_register_script( 'flot', WPCUES_BASICQUIZ_URL.'/common/js/flot/jquery.flot.min.js', array('jquery'), '3.6.4');
		wp_register_script( 'flot-pie', WPCUES_BASICQUIZ_URL.'/common/js/flot/jquery.flot.pie.min.js', array('jquery'), '3.6.5');
		wp_enqueue_script('flot');
		wp_enqueue_script('flot-pie');
		wp_enqueue_script('wpcuebasicquiz-axislabel',WPCUES_BASICQUIZ_URL.'/common/js/flot/jquery.flot.axislabels.js');
		wp_enqueue_script('wpcuebasicquiz-chart',WPCUES_BASICQUIZ_URL.'/common/js/wpcuebasicquiz-chart.js');
		$chartid=$atts[0];
		...
		if(!(empty($chartmeta))){
			...
			wp_localize_script('wpcuebasicquiz-chart', 'anviprochart', array('data'=>$data,'chartoptions'=>$chartmeta));}else{$content='No Grade ';}	
		return $content;
	}
