...
{
    class WpCueBasicLevel extends WpCueQuiz_Base
    {
		...
		*/
		public static function wpcue_prolevel_admin_scripts(){
			wp_register_script( 'wpcuebasicquiz-level', WPCUES_BASICQUIZ_URL.'/admin/js/wpcuebasicquiz-level.js',array('jquery') );
			wp_enqueue_script('wpcuebasicquiz-level');
			$levelL10n=array('addnew'=>__('Add New','wpcues-basic-quiz'));
			wp_localize_script('wpcuebasicquiz-level','levelL10n',$levelL10n);
