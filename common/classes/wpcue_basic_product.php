...
{
    class WpCueBasicProduct extends  WpCueQuiz_Base
    {
		...
		*/
		...
		public function productsale_button($product_title,$product_desc,$productprice,$productcurrency,$productid){
			$wpprocuesetting=$this->_config->setting;$content='';
			if($wpprocuesetting['payment']['method'] == 1){
				...
				wp_enqueue_script('customstrip-popup', WPCUES_BASICQUIZ_URL. '/common/js/wpcuebasicquiz-stripepopup.js');
		...
		*/
		...
		public function wpcuequizbasic_trigger_check(){
			if(intval(get_query_var('wpcuequiz_stripe')) == 1) {
				...
				require_once(WPCUES_BASICQUIZ_PATH."/common/lib/stripe/Stripe.php");
				try{
