...
{
    class WpCueBasicGradeGroup extends WpCueQuiz_Base
    {
		...
		*/
		public function add_gradegroup(){
			...
			echo '</div>';
			echo '<div class="gradegrouptools"><div class="button button-primary save_gradegroup_button" style="float:right;">';
			_e('Save Grade Group','wpcues-basic-quiz');echo '</div><div class="button button-primary cancel_gradegroup_button" style="float:right;margin-right:1em;">';
		...
		public function grade_form($i,$gradeid,$gradetitle,$gradecontent,$gradebase,$gradebaseto,$gradebasefrom,$gradecerti){
			...
			wp_editor( $gradecontent,'grade-'.$i,array('wpautop'=>false,'textarea_rows'=>'50','default_editor'=>'tinymce','quicktags'=>true,'dfw'=>true,'editor_height'=>60,'tinymce'=>true,'media_buttons'=>true));
