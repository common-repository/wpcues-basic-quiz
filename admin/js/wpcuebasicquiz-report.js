...
$(document).on('click','#add_global_leaderboard',function(){
    ...
    $info.dialog({                   
		...
		var data2=$('#globleaderboard').serialize();
			...
			$htmlcontent+='<div class="row-actions"><span class="edit"><a href="#globalleaderboardedit">'+reportL10n.edit+'</a> | </span><span class="trash"><a class="submitdelete" title="Delete" href="#globalleaderboarddelete">'+reportL10n.delete+'</a> | </span></div>';
	...
	$info.dialog({                   
		...
		var data2=$('#quizleaderboard').serialize();
			...
			$htmlcontent+='class="alternate"';}
			$htmlcontent+='><td>';$htmlcontent+=$title;
			$htmlcontent+='<div class="row-actions"><span class="edit"><a href="#quizleaderboardedit">'+reportL10n.edit+'</a> | </span><span class="trash"><a class="submitdelete" title="Delete" href="#quizleaderboarddelete">'+reportL10n.delete+'</a> | </span></div>';
			$htmlcontent+='</td><td>[wpcuebasicleader '+$postid+']</td></tr>';
	...
	$info.dialog({                   
		...
		var data2=$('#quizchart').serialize();
			...
			}else{alert(reportL10n.chartadded);}
			}
			});
          $( this ).dialog( "close" );
					...
					buttons: {
						"Save": function() {
							...
							$.ajax({
								...
								$par.html($htmlcontent);
								}else{alert(reportL10n.chartsaved);}
								}
							});
						$( this ).dialog( "close" );
						
						$('#chartform').html($originchart);
					},	
					Cancel: function() {
