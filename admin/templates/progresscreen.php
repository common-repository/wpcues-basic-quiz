...
<div id='progressscreen-1' class='quizfinalscreen'>
		<?php
		if(!empty($quizmeta['quizfinal'][0])){$defcontent=wpautop($quizmeta['quizfinal'][0]);}else{
		$defcontent=__('<p>Congratulations - you have completed %%QUIZNAME%%.<br/></p>','wpcues-basic-quiz');}
		wp_editor( $defcontent,'quizfinal',array('wpautop'=>false,'textarea_rows'=>50,'editor_class'=> 'requiredvar','editor_height'=>100,'default_editor'=>'tinymce','quicktags'=>true,'dfw'=>true));?>
...
wp_editor($quizmeta['quizintermediate'][0],'quizintermediate',array('wpautop'=>false,'textarea_rows'=>50,'editor_class'=> 'requiredvar','editor_height'=>60,'default_editor'=>'tinymce','quicktags'=>true,'dfw'=>true)); ?>
<h3 class='smallheader'><?php _e('Usable  Variables','wpcues-basic-quiz');?></h3>
...
<?php if(empty($quizmeta['quizcomplete'][0])){
	...
	wp_editor($quizmeta['quizcomplete'][0],'quizcomplete',array('wpautop'=>false,'textarea_rows'=>50,'editor_class'=> 'requiredvar','editor_height'=>60,'default_editor'=>'tinymce','quicktags'=>true,'dfw'=>true)); ?>
</div>
</div>
