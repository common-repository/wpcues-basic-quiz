...
echo '<ul>';
echo '<li> '.__('Quiz','wpcues-basic-quiz').' : ';
...
echo '<option value="0">'.__('Select Quiz','wpcues-basic-quiz').'</option>';
...
echo '</select></span></li>';
echo '<li>'.__('Question','wpcues-basic-quiz').' : ';
...
echo '<li>'.__('Status','wpcues-basic-quiz').' : <select name="status">';
echo '<option value="0"';
if(empty($errortmeta['status'])){echo ' selected';}
echo '>'.__('open','wpcues-basic-quiz').'</option>';
echo '<option value="1"';
if(!empty($errortmeta['status'])){echo ' selected';}
echo '>'.__('Closed','wpcues-basic-quiz').'</option>';
echo '</select></li></ul>';
?>
</div>
