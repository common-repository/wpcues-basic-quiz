...
<div class="inside">
	...
	<div id="category-adder" class="wp-hidden-children">
				...
				<p id="category-add" class="category-add wp-hidden-child">
					...
					<input type="text" name="newcategory" id="newcategory" class="form-required form-input-tip" value="<?php _e('New Category Name','wpcues-basic-quiz'); ?>" aria-required="true"/>
	...
	<div id="displaysettingdiv" class="postbox">
		...
		<div id="displaysetting" class="displaydiv">
			...
			<?php if(!(empty($quizmeta['displaysetting']))){$displaysetting=maybe_unserialize($quizmeta['displaysetting'][0]); }?>
				...
				<li><input type='checkbox' name='showquestsymbol' value='1' class='requiredvar'  <?php if(!empty($displaysetting['showquestsymbol'])){echo 'checked';} ?>><?php _e('Show Question Symbol','wpcues-basic-quiz');?></li>
				<li><input type='checkbox' name='showquestnumber' value='1' class='requiredvar'  <?php if(!empty($displaysetting['showquestnumber'])){echo 'checked';} ?>><?php _e('Show Question Number','wpcues-basic-quiz');?></li>
				<li><input type='checkbox' name='savebuttonstat' value='1' class='requiredvar' <?php if(!empty($displaysetting['savebuttonstat'])){echo 'checked';} ?> disabled><?php _e('Show Save button','wpcues-basic-quiz');?><span class="procontent"></span></li>
				...
				<li><input type='checkbox' name='disableintermediate' class='requiredvar' value='1' <?php if(!empty($displaysetting['disableintermediate'])){echo 'checked';}?> disabled><?php _e('Do not show intermediate screen','wpcues-basic-quiz');?><span class="procontent"></span></li>
				<li><input type='checkbox' name='intermediatecontrol' value='1' class='requiredvar' <?php if(!empty($displaysetting['intermediatecontrol'])){echo 'checked';}?> disabled><?php _e('Do not show Continue button','wpcues-basic-quiz');?><span class="procontent"></span></li>
