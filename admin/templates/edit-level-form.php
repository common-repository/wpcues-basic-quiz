...
$.ajax({
 ...
 $(document).on('click','#publish',function(e){
	e.preventDefault();
	$leveltitle=$('#title').val();
	if(($leveltitle=== 'undefined')|| ($.trim($leveltitle).length ===0)){
		$('#messagesubmit').html('<p><?php _e('Please enter level name','wpcues-basic-quiz'); ?></p>');	
...
global $wpdb;
$trial=array();
$WpCueBasicLevel=new WpCueBasicLevel(new WpCueQuiz_Config($trial));
$post_type=$WpCueBasicLevel->showPosttype();
...
<input type="text" name="post_title" size="30" id="title" autocomplete="off" value='<?php if($error==1){echo $post_title;}else{echo $post->post_title;} ?>' placeholder="<?php _e('Enter Level Name here','wpcues-basic-quiz'); ?>" /></div>
<div class="inside">
...
<ul>
	<li><ul><li><?php _e('Level Rank','wpcues-basic-quiz'); ?></li><li><input type='text' name='levelrank' value='<?php if(isset($levelmeta['wpcuelevelrank'])){echo $levelmeta['wpcuelevelrank'][0];}else{echo 0;}?>'></li></ul></li>
	<li><ul><li><?php _e('Required Total Points','wpcues-basic-quiz'); ?></li><li><input type='text' name='levelreqdpoints' value='<?php if(isset($levelmeta['wpcuelevelpoints'])){echo $levelmeta['wpcuelevelpoints'][0];}else{echo 0;}?>'></li></ul></li>
	<li><ul><li><?php _e('Required average % correct answers from all tests','wpcues-basic-quiz'); ?></li><li><input type='text' name='levelcorrans' value='<?php if(isset($levelmeta['wpcuelevelpercorrect'])){echo $levelmeta['wpcuelevelpercorrect'][0];}else{echo 0;}?>'></li></ul></li>
	<li><ul><li><?php _e('Required number of unque tests taken','wpcues-basic-quiz'); ?></li><li><input type='text' name='levelnumquiz' value='<?php if(isset($levelmeta['wpcuelevelquiznum'])){echo $levelmeta['wpcuelevelquiznum'][0];}else{echo 0;}?>'></li></ul></li>
