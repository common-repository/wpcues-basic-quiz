...
$trial=array();
$WpCueBasicProduct=new WpCueBasicProduct(new WpCueQuiz_Config($trial));
$post_type=$WpCueBasicProduct->showPosttype();
...
<div id="productmeta">
<ul>
<li><ul><li><?php _e('Open till','wpcues-basic-quiz'); ?> :</li><li><input type='text' name='productexpiry' id='productexpiry' value='<?php if(isset($productmeta['wpcueproductexpiry'])){echo $productmeta['wpcueproductexpiry'][0];} ?>'></li></ul></li>
<li><ul><li><?php _e('Price','wpcues-basic-quiz'); ?> :</li><li><input type='text' name='productprice' value='<?php if(isset($productmeta['wpcueproductprice'])){echo $productmeta['wpcueproductprice'][0];}else{echo 0;}?>'></li></ul></li>
<li><ul><li><?php _e('Currency','wpcues-basic-quiz'); ?> :</li><li><select name="productcurrency" id='productcurrency'>
<?php $customcur=0; ?>
...
<li><ul><li><?php _e('No. of Units','wpcues-basic-quiz'); ?> :</li><li><input type='text' name='productunits' value='<?php if(isset($productmeta['wpcueproductunits'])){echo $productmeta['wpcueproductunits'][0];}else{echo 0;}?>'></li></ul></li>
