<div id="emailnotificationtab">
	...
	<?php if(empty($adminemail['mail'])){$adminemail['mail']=__('%%USERNAME%% has taken the quiz %%QUIZNAME%% on %%DATE%%.The report is as follows : %%REPORT%%','wpcues-basic-quiz');} 
		wp_editor( $adminemail['mail'],'adminemail',array('wpautop'=>false,'textarea_rows'=>50,'editor_height'=>100,'default_editor'=>'tinymce','editor_class'=> 'requiredvar','quicktags'=>true,'dfw'=>true));?>
	</div>
	<div id="emailnot2">
	<?php 
	...
	<?php if(empty($useremail['mail'])){$useremail['mail']=__('Thanks %%USERNAME%% for taking %%QUIZNAME%% quiz.','wpcues-basic-quiz');} 
		wp_editor( $useremail['mail'],'useremail',array('wpautop'=>false,'textarea_rows'=>50,'editor_height'=>100,'default_editor'=>'tinymce','editor_class'=> 'requiredvar','quicktags'=>true,'dfw'=>true));?>
	</div>
	<div>
